...
ec2instances="cherry steve vicky"
...
do
  ...
  ansible-playbook $DEBUG -i environment/hosts --extra-vars="customer=${host}" --extra-vars="customer_domain=${host}.example.com" add.yml
done
